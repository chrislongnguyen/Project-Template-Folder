...
| `_shared/reference/effective-agent-principles-registry.md` | 10 Effective Principles (EP-01 through EP-10) with LT grounding and APEI application | During agent design or debugging |
