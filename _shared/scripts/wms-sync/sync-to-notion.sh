...
# See: _shared/skills/ltc-wms-adapters/notion/adapter.md §7 (MVP Workaround)
...
echo "     _shared/skills/ltc-wms-adapters/notion/field-map.md"
echo "  3. Follow hierarchy rules in:"
echo "     _shared/skills/ltc-wms-adapters/notion/task-protocol.md"
...
echo ""
echo "See: _shared/skills/ltc-wms-adapters/notion/adapter.md §6"
