...
#
# Protocol: _shared/skills/ltc-wms-adapters/clickup/adapter.md
# Field UUIDs: _shared/skills/ltc-wms-adapters/clickup/field-map.md
# Gotchas: _shared/skills/ltc-wms-adapters/clickup/gotchas.md
