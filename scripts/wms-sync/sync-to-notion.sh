...
# See: skills/wms-adapters/notion/adapter.md §7 (MVP Workaround)
...
echo "     skills/wms-adapters/notion/field-map.md"
echo "  3. Follow hierarchy rules in:"
echo "     skills/wms-adapters/notion/task-protocol.md"
...
echo ""
echo "See: skills/wms-adapters/notion/adapter.md §6"
