...
| **Iteration**   | Master Plan | A time-bound build cycle within a Project. Standard names: I1 Concept, I2 Prototype, I3 MVE, I4 Leadership. Parents its child Deliverables. Iteration's spec = sum of all Deliverable ACs (MECE). Each Iteration gates the next. | _"What does this build cycle deliver?"_ | All child Deliverables together cover the Iteration's scope completely. |
...
| **Iteration**   | `[SCOPE]_FA. {Code} I{N} — {Name}` _(Master Plan, no ID)_ | `[OPS]_OE. DFN I1 — Concept`                      |
