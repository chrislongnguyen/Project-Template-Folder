...
2. `DSBV-READY-{slug}.md` — Criterion 1-6 Readiness Package confirming downstream workstreams can start their Design phase
...
| Criterion 3 | Success rubric defined | GREEN | VANA-SPEC §6 AC-TEST-MAP ({N} ACs) |
...
All Criterion 1-6 GREEN → downstream DSBV workstreams (ALIGN, PLAN, EXECUTE, IMPROVE) may begin their Design phase using LEARN output as input.
