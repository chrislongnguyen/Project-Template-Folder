...
|------|--------------|-----------------|---------|----------|------------|
| P0 | `_genesis/templates/learning-book/page-0-overview-and-summary.md` | `Eff.{ABBREV}({role})` | 2 (R+A) | 2 (copy parent) | learn-input EO + research |
| P1 | `_genesis/templates/learning-book/page-1-ultimate-blockers.md` | `UBS({role})[.UB]*` | 2 (R+A) | 2-6 (3/chain) | P0 col 10 (UB) per role |
| P2 | `_genesis/templates/learning-book/page-2-ultimate-drivers.md` | `UDS({role})[.UD]*` | 2 (R+A) | 2-6 (3/chain) | P0 col 4 (UD) per role |
| P3 | `_genesis/templates/learning-book/page-3-principles.md` | `P[n]({pillar})({role})` / `P_F[n]({pillar})({role})` | 4-8 | 4-8+ | P0/P1/P2 col 6 + col 12 |
| P4 | `_genesis/templates/learning-book/page-4-components.md` | `{LAYER}.n({role})` | 4-8 | 4-8+ | P3 principles |
| P5 | `_genesis/templates/learning-book/page-5-steps-to-apply.md` | `STEP.n({role})` | 4-6 | 4-6+ | P1-P4 elements |
