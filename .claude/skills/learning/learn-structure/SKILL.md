...
3. Verify `1-ALIGN/learning/templates/page-0-overview-and-summary.md` exists.
...
```bash
bash 1-ALIGN/learning/scripts/validate-learning-page.sh \
  1-ALIGN/learning/output/{system-slug}/T{n}.P{m}-{name}.md {page-type} {topic-depth}
```
