...
3. **§2 Mechanics** — 2.1 How It Works (Q4), 2.2 Why It Works (Q5), 2.3 Why It Fails (Q6 + Counterevidence Register) → Edit/append
4. **§3 Application** — 3.1 How We Can Benefit (Q7), 3.2 Recommendations (Q8) → Edit/append
5. **§4 Mastery** — 4.1 Misconceptions (Q9), 4.2 Anti-Patterns (Q10), 4.3 Contingencies (Q11), 4.4 Competitive Edge (Q12) → Edit/append
