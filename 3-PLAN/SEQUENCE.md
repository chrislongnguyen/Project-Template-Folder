...
owner: "{{OWNER}}"
---
# DSBV Context Package — PLAN Workstream
...
<!-- Fill in project-specific content: what the project IS and IS NOT, system boundary -->

<!-- TODO: 1-2 paragraphs describing what the project IS and IS NOT. Include system boundary — in scope vs out of scope. -->
...
<!-- TODO: Key outputs from preceding workstream(s) — ALIGN and LEARN — that constrain or inform this workstream's work. -->
...
<!-- TODO: Specify single-agent or multi-agent pattern and each agent's role. -->
...
<!-- TODO: Primary — what makes THIS workstream's output valuable -->
<!-- TODO: Secondary — e.g., "find non-obvious risks" for PLAN -->
