...
```
  1-ALIGN/charter/REQUIREMENTS.md ──────► 3-EXECUTE/src/
  2-PLAN/risks/UBS_REGISTER.md ──────────► 3-EXECUTE/tests/
  2-PLAN/architecture/SYSTEM_DESIGN.md ──► 3-EXECUTE/config/
  2-PLAN/roadmap/EXECUTION_PLAN.md ──────► 3-EXECUTE/docs/
```
