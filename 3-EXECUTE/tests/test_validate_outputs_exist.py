"""
Tests for 3-EXECUTE/tests/quality-gates/stage-validators/validate-outputs-exist.py (Stage 5→6)
"""
import subprocess
import sys
import json
...
SCRIPT = Path(__file__).parent / "quality-gates" / "stage-validators" / "validate-outputs-exist.py"
