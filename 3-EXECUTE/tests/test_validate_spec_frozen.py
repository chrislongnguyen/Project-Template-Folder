"""
Tests for 3-EXECUTE/tests/quality-gates/stage-validators/validate-spec-frozen.py (Stage 2→3)
"""
import subprocess
import sys
import json
...
SCRIPT = Path(__file__).parent / "quality-gates" / "stage-validators" / "validate-spec-frozen.py"
