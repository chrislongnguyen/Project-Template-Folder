"""
Tests for 3-EXECUTE/tests/quality-gates/stage-validators/validate-exec-readiness.py (Stage 4→5)

This validator is now standalone (all 10 checks inlined; no subprocess delegation
to 2-PLAN/skills/ltc-execution-planner/scripts/readiness-check.py).
"""
import subprocess
import sys
from pathlib import Path

SCRIPT = Path(__file__).parent / "quality-gates" / "stage-validators" / "validate-exec-readiness.py"
