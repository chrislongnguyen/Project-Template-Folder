"""
Tests for 3-EXECUTE/tests/quality-gates/stage-validators/validate-spec-mece.py (Stage 1→2)
"""
import subprocess
import sys
from pathlib import Path

SCRIPT = Path(__file__).parent / "quality-gates" / "stage-validators" / "validate-spec-mece.py"
