...
The sync scripts (`_genesis/scripts/wms-sync/sync-to-clickup.sh`, `_genesis/scripts/wms-sync/pull-comments.sh`) are **coordination wrappers**, not autonomous executors. They:
