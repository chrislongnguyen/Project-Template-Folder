...
const stages = [
  {
    ...
    detail: '/vault-capture or Obsidian Web Clipper (⌥⇧O)',
    sub: 'Drops to PERSONAL-KNOWLEDGE-BASE/captured/',
    tool: '/vault-capture  or  ⌥⇧O',
  },
  {
    ...
    detail: 'File to captured/ folder, or Web Clipper auto-files by topic',
    sub: 'Nothing moved until you are ready',
    tool: 'drag-and-drop or Web Clipper auto-route',
  },
  {
    accent: colors.gold,
    label: 'DISTIL',
    ...
    detail: '5-step pipeline: Read new in captured/ → Find related via _index.md → Write wiki pages in distilled/{topic}/ → Append to _log.md → Update _index.md catalog',
    sub: '',
    tool: '/ingest',
  },
  {
    ...
    detail: 'QMD indexes distilled/ (SessionStop hook). Agent auto-recalls via MCP in future sessions. Browse in Obsidian: backlinks, graph, Spaced Repetition.',
    sub: '',
