...
export default function MorningStandupSlide() {
  return (
    <SlideLayout>
      ...
      >
        ...
        {/* Content: left annotations + right screenshot */}
        <div style={{ flex: 1, display: 'flex', gap: '32px', minHeight: 0 }}>
          ...
          >
            ...
            <div>
              ...
              {[
                { label: 'OPEN THIS FIRST', detail: 'every morning before anything else', accent: colors.gold },
                { label: 'SHOWS:', detail: 'files modified in the last 24–72 hours', accent: colors.midnightLight },
                { label: 'ACTIVITY BANDS:', detail: 'TODAY · LAST 3 DAYS · THIS WEEK', accent: colors.midnightLight },
              ].map((item, i) => (
                <div
                  key={i}
                  style={{
