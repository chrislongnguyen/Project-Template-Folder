    ...
    <SlideLayout>
      ...
      >
        ...
        >
          ...
          >
            Every LTC member works through all 4 sub-systems. Each sub-system follows the full ALPEI flow (5 zones × 4 DSBV phases) across 5 iterations (I0–I4). PD sets the version ceiling for all downstream sub-systems.
          </p>
        </motion.div>
      </div>
    </SlideLayout>
