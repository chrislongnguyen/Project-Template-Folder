...
|---|---|---|
| **Scope** | Define what to learn — root causes, failure mechanisms, success drivers, knowledge gaps | Learning scope; prioritized research questions; data collection plan |
...
| **Production** | Execute UBS/UDS analysis; validate findings; produce effective principles and solution design | **Completed UBS; Completed UDS; Finalized EP; Solution design** |
| **Audit** | Verify diagnosis is rigorous, evidence-based, complete, and actionable | Validated learning package → PLAN |
