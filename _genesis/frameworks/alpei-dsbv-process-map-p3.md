...
When you run `/dsbv design align pd`, a structured sequence of agents, rules, and human gates activates — not a chat. Every artifact is produced under contract (DESIGN.md), every stage transition requires your approval, and five always-on rules enforce quality at every step. The walkthrough below traces exactly what happens, from the moment you type the command to the moment ALIGN is marked complete.
...
| G3 | Human approves Build output in `1-ALIGN/1-PD/` | Validate cannot start |
| G4 | Human approves `1-ALIGN/1-PD/VALIDATE.md` (all criteria PASS) | LEARN workstream cannot start; ALIGN/PD not marked complete |
...
>
> **G1 — Design complete.** I produced: `1-ALIGN/1-PD/DESIGN.md` (3 artifacts, 0 orphan conditions). Ready to proceed to Sequence?

**PM:** Looks good. Proceed.

**ltc-planner:** G1 approved. Running `/dsbv sequence align pd`.
