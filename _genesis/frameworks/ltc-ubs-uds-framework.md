...
|---|---|---|
| **ALIGN** | Scope | Initial risk register — what could go wrong with scope? |
| **ALIGN** | Design | Risk mitigation plan in master plan |
| **ALIGN** | Audit | Cross-reference risks with LEARN findings |
| **LEARN** | Scope | Learning risk register — what are the unknown unknowns? |
| **LEARN** | Production | **UBS/UDS/EP analysis — the core risk identification** |
| **LEARN** | Audit | Verify diagnosis is evidence-based |
| **PLAN** | Scope | Planning risk register — can we deliver on time? |
| **PLAN** | Design | Derisk-first sequencing — sustainability before efficiency |
| **PLAN** | Audit | Verify plan is realistic and risk-managed |
| **EXECUTE** | Scope | Blocker log — catch blockers before work begins |
| **EXECUTE** | Production | Quality gates check three pillars |
| **EXECUTE** | Audit | Defect log — what broke and why? |
| **IMPROVE** | Scope | Feedback risk register — what could go wrong with feedback? |
| **IMPROVE** | Production | Risk events + near misses — what actually happened vs. predicted |
| **IMPROVE** | Audit | Were risk priorities fair and evidence-based? |
