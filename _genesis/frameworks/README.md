...
**Purpose:** Operational models that implement principles — the methods LTC uses to build and run systems.

**Cascade position:** Layer 3 of 4 — translates WHAT into HOW we operate.
