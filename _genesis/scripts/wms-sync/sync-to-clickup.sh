...
#
# Protocol: _genesis/skills/ltc-wms-adapters/clickup/adapter.md
# Field UUIDs: _genesis/skills/ltc-wms-adapters/clickup/field-map.md
# Gotchas: _genesis/skills/ltc-wms-adapters/clickup/gotchas.md
