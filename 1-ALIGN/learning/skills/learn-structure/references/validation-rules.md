# Validation Rules — UEDS Page Output
...
**P0 CAG prefix format:** `Eff.{ABBREV}(R).` — e.g., `Eff.DF(R).REL:`, `Eff.AI-UEDS(A).UD:`.
...
## 6. UEDS Term Compliance

Cells must use UEDS column suffixes exclusively:
