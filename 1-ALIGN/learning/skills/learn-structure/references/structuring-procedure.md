# Structuring Procedure — UEDS Page Generation

This is the detailed step-by-step procedure for generating 6 UEDS pages from research output. The SKILL.md references this file. Follow steps in exact order.
...
Scan the research body and identify sections that map to UEDS pages:
...
### Read
- `1-ALIGN/learning/templates/page-0-overview-and-summary.md`
- `1-ALIGN/learning/input/learn-input-{system-slug}.md` for Workstream Contract and RACI fields
...
### Read
- `1-ALIGN/learning/templates/page-1-ultimate-blockers.md`
...
### Read
- `1-ALIGN/learning/templates/page-2-ultimate-drivers.md`
...
1. `1-ALIGN/learning/output/{system-slug}/T{n}.P0-overview-and-summary.md`
2. `1-ALIGN/learning/output/{system-slug}/T{n}.P1-ultimate-blockers.md`
3. `1-ALIGN/learning/output/{system-slug}/T{n}.P2-ultimate-drivers.md`
...
### Read
- `1-ALIGN/learning/templates/page-3-principles.md`
...
### Read
- `1-ALIGN/learning/templates/page-4-components.md`
...
### Read
- `1-ALIGN/learning/templates/page-5-steps-to-apply.md`
...
for page in P0 P1 P2 P3 P4 P5; do
  file=$(ls 1-ALIGN/learning/output/{system-slug}/T{n}.${page}-*.md 2>/dev/null)
  if [ -n "$file" ]; then
    bash 1-ALIGN/learning/scripts/validate-learning-page.sh "$file" "$page" "T{n}"
  fi
done
```
