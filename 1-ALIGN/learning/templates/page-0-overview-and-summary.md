...
- **DUPLICATE the parent page — do not regenerate. Copy ALL rows (both R and A).**
  ...
  - Topic 4 Page 0 = copy of Topic 0 Page 4 (EOE/EOT rows)
...
| Col 7+8 · EOT/EOE | Seeds the components/tools for Page 4 (from both R and A rows)                     |
...
| EO         | [Workstream-specific desired outcome — the STATE this workstream aims to achieve] |
