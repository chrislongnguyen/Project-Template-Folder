...
owner: "{{OWNER}}"
---
# DSBV Context Package — ALIGN Workstream

> Input context for agents running DSBV Build phase on Workstream ALIGN (Zone 1).
...
<!-- Single-agent or multi-agent role description. Example:
"You are the sole agent producing the ALIGN artifacts. Output will be validated against the rubric by the Human Director." -->
...
- <!-- Primary: what makes ALIGN output valuable -->
- <!-- Secondary: e.g., "find non-obvious stakeholder conflicts" -->
