...
| Scope | 6+1 skills replacing 7 legacy skills in `2-LEARN/skills/` |
...
| A.C. ID | VANA Word | Criteria | Source | Eval Type | Threshold |
|---------|-----------|----------|--------|-----------|-----------|
| Noun-AC1 | orchestrator-skill | `2-LEARN/skills/learn/SKILL.md` exists with state-derivation logic, routing table, and flow diagram | Design:architecture | Deterministic | File exists; contains routing table for 5 states |
| Noun-AC2 | input-skill | `2-LEARN/skills/learn-input/SKILL.md` exists with 9-question interview, EO validation gate, escape hatch | Design:architecture | Deterministic | File exists; 9 questions listed; EO gate documented |
| Noun-AC3 | research-skill | `2-LEARN/skills/learn-research/SKILL.md` exists with parallel dispatch, source verification gate, escape hatches | Design:architecture | Deterministic | File exists; parallel dispatch instruction; source gate documented |
| Noun-AC4 | structure-skill | `2-LEARN/skills/learn-structure/SKILL.md` exists with per-topic P0-P5 generation, Opus fork, mermaid companions | Design:architecture | Deterministic | File exists; per-topic scope; model fork instruction |
| Noun-AC5 | review-skill | `2-LEARN/skills/learn-review/SKILL.md` exists with per-topic review, causal spine table, active learning Qs | Design:architecture | Deterministic | File exists; per-topic scope; comprehension Q instruction |
| Noun-AC6 | spec-skill | `2-LEARN/skills/learn-spec/SKILL.md` exists with VANA extraction, DSBV Readiness Package generation, P-page→zone mapping | Design:architecture | Deterministic | File exists; mapping table for P0-P5→zones |
| Noun-AC7 | visualize-skill | `2-LEARN/skills/learn-visualize/SKILL.md` exists with React+Vite generation, LTC brand, interactive system map | Design:architecture | Deterministic | File exists; brand requirements listed; interactivity spec |
...
| Physical Resources | File system (2-LEARN/); network (EXA, WebSearch) | Markdown files; optional React+Vite HTML app |
...
- Create/edit skill files in `2-LEARN/skills/`
