...
Each template must be mapped: **which DSBV phase produces it, in which ALPEI zone, with what acceptance criteria?** This is a design task, not a copy task. Planned for Session N+1.
