...
- **Hook edge case: operational files blocked (7-CS: EOE).** The initial dsbv-skill-guard.sh hook blocked writes to 5-IMPROVE/retrospectives/ because no 5-IMPROVE/DESIGN.md existed. Fix: allowlist for operational files (retros, changelogs, ADRs, metrics, learning) that are updated incrementally outside DSBV cycles.
...
| Hook enforcement test | dsbv-skill-guard.sh caught ad-hoc write to 5-IMPROVE/ within 30 seconds of deployment |
