"""
Tests for 3-EXECUTE/scripts/generate-review-package.py

Uses a fixture .exec/ directory at 3-EXECUTE/tests/fixtures/review-package-exec/
"""
import subprocess
import json
import sys
...
SCRIPT = Path(__file__).parent.parent / "scripts" / "generate-review-package.py"  # 3-EXECUTE/scripts/
