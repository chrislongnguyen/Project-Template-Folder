...
Example:
> Do NOT hardcode the ClickUp field UUID for `task_type` — UUIDs change per workspace and are already defined in `_shared/skills/ltc-wms-adapters/clickup/field-map.md`; reference that file rather than embedding the UUID in the script.
