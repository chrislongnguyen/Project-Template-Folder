...
<!-- Per SYSTEM-THINKING-DESIGN-NOTES-v2.md: classify each 7-CS component
     into Below Threshold / Leverage Zone / Saturated -->

| Component | Current Zone | Signal | Action |
|---|---|---|---|
| EPS | {zone} | {evidence} | {invest / keep investing / move on} |
| Input | {zone} | {evidence} | {invest / keep investing / move on} |
| EOP | {zone} | {evidence} | {invest / keep investing / move on} |
| Environment | {zone} | {evidence} | {invest / keep investing / move on} |
| Tools | {zone} | {evidence} | {invest / keep investing / move on} |
| Agent | {zone} | {evidence} | {invest / keep investing / move on} |
...
<!-- Derivation: T0.P4 Components — organized by UES layer (I1).
...
<!-- Every A.C. must trace back to the UDO through this 4-link chain:
     A.C. ← VANA Grammar Element ← ESD Phase 2 Decision ← ILE Page ← UDO -->

| A.C. ID | VANA Element | ESD Decision | ILE Source | UDO Link |
|---------|-------------|-------------|-----------|----------|
