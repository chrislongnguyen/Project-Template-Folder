...
**Intent:** _Human states what this IMPROVE workstream must produce and why._
...
<!-- Fill in project-specific IMPROVE artifacts here -->
...
|------------|-------------------|--------|
| Metrics baseline | EXECUTE | Ready / Pending |
